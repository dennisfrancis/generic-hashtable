...
int primes[]
    = { 11177, 10301, 11173, 11933, 10729, 10159, 10357, 11329, 11941, 11047, 11483, 11369 };

char* get_strkey(void* el) { return (((vertex_t*)el)->id); }
...
int main()
{
    ...
    int i;
    int bSuccess = 1;
    char* ids[] = { "id12345", "id14345", "id16345", "id17345",
                    "id18345", "id11345", "id10345", "id19345" };
    hashparam_t parm;
    hashtable_t ht;
